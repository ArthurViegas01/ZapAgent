...
def _override_settings() -> None:
    ...
    Tests run against the EvolutionProvider by default to keep the existing
    ...
    settings.evolution_api_key = "changeme"
    settings.evolution_webhook_token = ""
    settings.evolution_webhook_base_url = "http://api:8000/webhooks/whatsapp"
    reset_provider()
...
def base_state() -> AgentState:
    ...
    return AgentState(
        ...
        user_message="Quero agendar um horario para amanha as 10h",
    )
    ...
    base_state["faq_matches"] = [
        {
            ...
            "answer": "Atendemos de segunda a sabado, das 9h as 19h.",
            "score": 0.92,
        }
    ]
